...
export type ConstantItem = 'TYPE' | 'REGION' | 'GEN' | 'FILTER_ITEMS' | 'PL' | 'SITUATION' | 'WEATHER'
export type SimpEntryItem = 'REGION' | 'GEN' | 'FILTER_ITEMS' | 'SITUATION' | 'WEATHER'
